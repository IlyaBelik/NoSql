...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("labbbb5")//namespace
                .setEventHubName("lab5")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://labbbb5.servicebus.windows.net/;SharedAccessKeyName=lab5-policy;SharedAccessKey=4pyrsnB+xzOwemqF0yXbk83ZSo6P/oUKmhtAnuNHdBs=;EntityPath=lab5")
                /*Primary key*/
                .setSasKey("4pyrsnB+xzOwemqF0yXbk83ZSo6P/oUKmhtAnuNHdBs=");
