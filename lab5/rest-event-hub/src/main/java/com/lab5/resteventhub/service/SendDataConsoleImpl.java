...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "labbbb5.redis.cache.windows.net";
    private final static String CACHE_KEY = "Is6PHMVy78y8kFwPYoKsGtEc75lS8xvNGdrgsu5TmYQ=";
